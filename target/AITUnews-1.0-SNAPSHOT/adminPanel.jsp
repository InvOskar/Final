    ...
    <ul class="links__list" style="--item-total:5">
        ...
        <li class="links__item" style="--item-count:3">
            <a class="links__link" href="editClubs.jsp">
                ...
                <span class="links__text">Edit Clubs</span></a>
        </li>
        ...
        <li class="links__item" style="--item-count:5">
            <a class="links__link" href="StudentListAdminServlet">
                <img class="links__icon" src="https://cdn.iconscout.com/icon/premium/png-256-thumb/edit-users-618522.png">
                <span class="links__text">Edit Students</span></a>
        </li>
    </ul>
</div>
</body>
