...
public class AnySearchServlet extends GenericServlet{
    public void service(ServletRequest req,ServletResponse res) throws IOException,ServletException
    {
        ...
        try {
            ...
            String searchSomething=req.getParameter("anything");
            PreparedStatement ps = con.prepareStatement("Select * from users where Username=? or Name=? or Surname=? or Major=? or SGroup=? or Year=?");
            ps.setString(1, searchSomething);
            ps.setString(2, searchSomething);
            ps.setString(3, searchSomething);
            ps.setString(4, searchSomething);
            ps.setString(5, searchSomething);
            ps.setString(6, searchSomething);
