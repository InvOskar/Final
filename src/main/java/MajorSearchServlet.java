...
public class MajorSearchServlet extends GenericServlet{
    public void service(ServletRequest req,ServletResponse res) throws IOException,ServletException
    {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("Select * from users where Major=?");
            ps.setString(1, searchMajor);
